...
Jetpack Joyride是一款充滿能量道具、任務和收藏品的無盡動作遊戲。`,
  ...
  'fireboy-and-watergirl': {
    title: 'Fireboy and Watergirl — 森林神廟',
    description: `操控兩個對立的元素英雄通過 32 個合作解謎關卡。火焰男孩免疫火焰，水之少女免疫水流 — 觸碰錯誤元素即刻死亡。拉動拉桿開門，同時將兩人引導至出口。

2009 年發布，是最受喜愛的瀏覽器遊戲系列之一，五部合計遊玩次數超過 5 億次。全球教師將其用作團隊協作訓練。`,
    controls: `玩家 1（火焰男孩）：方向鍵移動和跳躍。玩家 2（水之少女）：WASD 移動。火焰男孩碰水死亡，水之少女碰火死亡。兩人碰綠色毒液均死亡。同時將兩人引導至對應顏色的出口。`,
  },
  'ovo': {
    title: 'OvO — 跑酷平台跳躍',
    description: `在 40 多個精準平台關卡中衝刺、滑行和跳躍。掌握俯衝擊地穿越障礙下方，以及蹬牆跳建立捷徑。

由 Dedragames 製作，2021 年病毒式傳播。速通玩家可在 3 分鐘內通關。`,
    controls: `方向鍵或 WASD 奔跑。空格或 ↑ 跳躍。空中按 ↓ 俯衝擊地。奔跑時俯衝可滑行。緊貼牆壁跳躍可蹬牆跳。`,
  },
  'basketball-stars': {
    title: 'Basketball Stars — 1v1 街頭籃球',
    description: `與 AI 或朋友進行一對一籃球對決。欺騙防守者，在完美時機完成三分球或精彩灌籃。

由 Madpuffers 開發。角色陣容以 NBA 超級巨星為靈感，每天有數十萬玩家在線。`,
    controls: `玩家 1：A/D 移動，W 跳躍，S 防守/搶斷。B 或點擊投籃。玩家 2：方向鍵，↑ 跳躍，↓ 防守。L 或點擊投籃。`,
  },
  'monkey-mart': {
    title: 'Monkey Mart — 超市經營',
    description: `扮演可愛的猴子經營自己的超市！收穫農產品、補充貨架，在顧客失去耐心前為其服務。雇用助手猴自動化工作，解鎖新區域。

自 2022 年以來遊玩次數超過 1 億次。獨立開發者 TinyDobbins 僅用三個月完成。`,
    controls: `方向鍵或 WASD 行走。走過農田自動收穫。走向空貨架自動補貨。花費金幣解鎖新區域和助手。`,
  },
  'short-life': {
    title: 'Short Life — 障礙跑道生存',
    description: `操控布娃娃角色通過充滿旋轉鋸刀、槌子和地雷的致命障礙跑道。標題不是誇張 — 死亡、大笑，然後立刻再試。

由 RHM Interactive 開發。20 個難度遞增關卡，物理引擎讓每次死亡都各不相同。`,
    controls: `方向鍵或 WASD 移動和跳躍。所有危險物品瞬間致死。到達每關末尾的旗幟繼續前進。每次死亡後立即重新開始。`,
  },
  '1v1-lol': {
    title: '1v1.LOL — 建造與射擊',
    description: `在建造-戰鬥競技場中廝殺，生存需要精準射擊和更快的建造。設置牆壁和斜坡佔據高地，然後消滅對手。

無行銷預算卻擁有超過 2 億註冊用戶。通過學校口耳相傳在全球傳播。`,
    controls: `WASD 移動。滑鼠瞄準/射擊。Q 牆壁，E 地板，R 斜坡，F 屋頂。Shift 衝刺。滑鼠滾輪切換武器。`,
  },
  'smash-karts': {
    title: 'Smash Karts — 多人卡丁車競技',
    description: `跳上卡丁車，用火箭、機槍和地雷在這個快節奏戰鬥競技場消滅對手。收集武器箱，成為最後一輛卡丁車。

2023 年遊玩次數超過 1.5 億次。專用伺服器確保低延遲。`,
    controls: `WASD 或方向鍵駕駛。滑鼠瞄準。空格或點擊射擊。收集武器箱。時間結束時消滅數量最多者獲勝。`,
  },
  'penalty-shooters-2': {
    title: 'Penalty Shooters 2 — 點球大戰',
    description: `在 8 個國際賽事的點球大戰中承受最高強度的足球壓力。作為射手觀察守門員的傾斜方向。作為守門員讀出射門方向。

遊玩次數超過 2 億次。包含 50 多支國家隊及其真實球衣顏色。`,
    controls: `作為射手：滑鼠瞄準，點擊射門。守門員會傾斜 — 利用提示。作為守門員：點擊正確一側撲救。`,
  },
  'getaway-shootout': {
    title: 'Getaway Shootout — 混亂逃跑競賽',
    description: `在這個混亂的 brawler 遊戲中，趕在對手之前跳上、射擊並跌跌撞撞地到達逃跑車輛。操控設計故意笨拙 — 交替左右跳躍 — 讓每場比賽都成為喜劇。

由 New Eich Games 開發。隨機重新整理的武器保證每場比賽各不相同。`,
    controls: `玩家 1：W 向左跳，E 向右跳，R 使用道具。玩家 2：I 左，O 右，P 道具。最先到達車輛者贏得本輪。`,
  },
  'big-tower-tiny-square': {
    title: 'Big Tower Tiny Square — 垂直平台跳躍',
    description: `扮演小方塊攀登高聳入雲的危險塔樓，每次只能通過一個致命房間。每層樓都有更殘酷的陷阱。目標是塔頂的鳳梨。

超過 110 個手工製作房間。普通玩家需要 3–5 小時和 2000 多次死亡才能到達頂部。`,
    controls: `方向鍵或 WASD 移動。空格、W 或 ↑ 跳躍。空中雙擊方向鍵獲得微小加速。任何危險物品瞬間致死，僅重置當前房間。`,
  },
  'worlds-hardest-game': {
