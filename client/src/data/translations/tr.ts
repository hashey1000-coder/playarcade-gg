...
Crazy Chicken (Moorhuhn), 1999 yılında Almanya'da bir reklam oyunu olarak başlamıştır. Kısa sürede viral bir fenomene dönüşmüş ve birçok devam oyunu çıkarılmıştır.`,
  ...
  'retro-bowl': {
    title: 'Retro Bowl — Amerikan Futbolu Menajerliği',
    description: `Retro Bowl, retro tarzda bir Amerikan futbolu yönetim oyunudur. Takımınızı yönetin, taktik kararlar alın ve şampiyonluğa uzanın. Paslar atın ve touchdown yaparak maçları kazanın.

Saha dışı takım yönetimi ile saha içi aksiyonu bir arada sunar. Oyuncu transferleri yapın, yetenekleri geliştirin ve bütçeyi yöneterek hayalinizdeki takımı kurun.`,
    controls: `Kaydırarak pas atın ve alıcıları hedefleyin. Maçlar arasında yönetim menüsünden takımınızı düzenleyin.`,
  },
  'run-3': {
    title: 'Run 3 — Sonsuz Uzay Koşucusu',
    description: `Run 3, değişen uzay tünellerinde sonsuz bir koşu oyunudur. Duvarlarda ve tavanlarda koşun, boşluklardan kaçının ve giderek zorlaşan seviyeleri aşın.

Benzersiz döndürme mekaniği sayesinde tünelin her yüzeyinde koşabilirsiniz. Farklı yeteneklere sahip karakterleri açın ve keşif ile sonsuz modlarda düzinelerce seviyeyi keşfedin.`,
    controls: `Ok tuşları veya A/D ile sağa-sola hareket edin. Boşluk veya yukarı ok ile zıplayın.`,
  },
  'crossy-road': {
    title: 'Crossy Road — Sonsuz Zıplama',
    description: `Crossy Road, klasik Frogger'dan esinlenen sonsuz bir zıplama oyunudur. Yoğun yolları, tren raylarını ve nehirleri doğru zamanlama ile geçin.

Sevimli voksel grafikleri ve düzinelerce açılabilir karakterle dolu. Her karakter benzersiz bir görünüm kazandırır. En uzak mesafe rekorunuzu kırmaya çalışın!`,
    controls: `Tıklayın veya boşluk tuşuna basarak ileri zıplayın. Ok tuşlarıyla sağa-sola hareket edin. Araçlara ve trenlere dikkat edin!`,
  },
  'cut-the-rope': {
    title: 'Cut the Rope — Om Nom\'a Şeker Ver',
    description: `Cut the Rope, eğlenceli bir fizik bulmaca oyunudur. İpleri keserek şekeri aç Om Nom'a ulaştırın ve her seviyede üç yıldızı da toplayın.

Balonlar, yastıklar ve portallar gibi çeşitli mekaniklerle yüzlerce seviye sunar. Her yeni bölüm yaratıcı düşüncenizi sınayan farklı bir unsur ekler.`,
    controls: `İpleri kesmek için fareyi sürükleyin. Balonlar ve pompalar gibi çevresel öğeleri kullanın. Üç yıldızın tamamını toplamaya çalışın!`,
  },
  'stickman-hook': {
    title: 'Stickman Hook — Sallan ve Uç',
    description: `Stickman Hook, hızlı tempolu bir fizik sallanma oyunudur. Doğru zamanlama ile noktadan noktaya sallanarak seviyeleri akrobatik bir şekilde geçin.

Gerçekçi sarkaç fiziği ve yaratıcı seviye tasarımı sunar. Renkli karakterler açın ve yüzlerce seviyede zamanlama becerilerinizi test edin.`,
    controls: `Tıklayın veya boşluk tuşuyla bir sonraki sallanma noktasına tutunun. Doğru açıda bırakın. Başarının anahtarı zamanlamadır!`,
  },
  'drive-mad': {
    title: 'Drive Mad — Fizik Sürüş Mücadelesi',
    description: `Drive Mad, çılgın engellerle dolu bir fizik sürüş oyunudur. Rampalı, döngülü ve bariyerli parkurlarda devrilmeden ilerlemeye çalışın.

Her seviye hız ve kontrol arasında hassas bir denge gerektirir. Engeller giderek zorlaşır ve beklenmedik sürprizler karşınıza çıkar.`,
    controls: `Yukarı ok veya W ile hızlanın, aşağı ok veya S ile fren yapın. Rampalarda dengenizi dikkatli koruyun!`,
  },
  'paper-io-2': {
    title: 'Paper.io 2 — Toprak Fethi',
    description: `Paper.io 2, mümkün olan en geniş alanı ele geçirmeniz gereken rekabetçi bir .io oyunudur. Topraklarınızdan çıkarak yol çizin ve geri dönerek alanı sahiplenin.

Basit ama son derece rekabetçi. Genişlerken kuyruğunuzu koruyun ve rakiplerin yollarını keserek onları eleyip topraklarını ele geçirin.`,
    controls: `Ok tuşları veya kaydırma ile yön değiştirin. Kendi alanınızdan çıkın, yol çizin ve geri dönerek toprak kazanın.`,
  },
  'subway-surfers': {
    title: 'Subway Surfers — Sonsuz Metro Koşucusu',
    description: `Subway Surfers, popüler bir sonsuz koşu oyunudur. Jake'i metro güvenliğinden ve köpeğinden kaçırarak raylar üzerinde koşturun. Altın toplayın ve kaykay kullanarak korunun.

Değişen dünya lokasyonları ve canlı grafiklerle sürekli taze bir deneyim sunar. Farklı karakterler ve kaykaylar açın, güçlendiriciler kullanarak en uzak mesafeye ulaşın.`,
    controls: `Sağa-sola kaydırarak şerit değiştirin. Yukarı kaydırarak zıplayın, aşağı kaydırarak kayın.`,
  },
  'jetpack-joyride': {
    title: 'Jetpack Joyride — Sonsuz Jetpack Aksiyonu',
    description: `Jetpack Joyride'da Barry Steakfries bir jetpack'le gizli bir laboratuvara dalış yapar. Engellerden kaçının, altın toplayın ve özel araçlara binin.
...
Olağanüstü sabır, konsantrasyon ve kusursuz zamanlama gerektirir. Her seviye, karmaşık hareket kalıplarıyla sınırlarınızı zorlar.`,
    controls: `Ok tuşları veya WASD ile kırmızı kareyi hareket ettirin. Mavi topların hareket kalıplarını izleyin ve doğru anda ilerleyin.`,
  },
};
